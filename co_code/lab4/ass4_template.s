...
;ACCESS BIG ADDRESS
mov [GS:0xFFFFC020], dword 0xaaaaaaaa

;GENERATE PAGE FAULT
mov [GS:0xFFFFE030], dword 0xbbbbbbbb

;JUMPING CODE
mov [GS:0xFFFFC000], dword 0xbebebece
jmp 0x50:0xFFFFF400
...
btc eax, 31
mov cr0, eax
jmp chanHappy;################-----ESCAPE AND JUMP TO CHANHAPPY-----###########




;###################------CODE SNIPPETS TO JUMP TO------###################
;JUMP TO HERE
align 0x200
page_jump_test:
mov [GS:0xb004], dword 0xbcbcbcbc
jmp 0x8:0x200
...
align 0x200
    pop eax
    mov [GS:0xb010], dword 0xabcddcba   ;#########---MARKER TO CHECK IF ISR WAS CALLED
...
; Default Data Segment Descriptor of type 2, DPL = 0
 ...
 ;Segment Descriptor for Segment data
...
;Segment Descriptor for Page Tables
dw 0x2000	;Limit 15->0
dw 0xe000	;Base 15->0
db 0		;Base 23->16
db 10010010b;P=1 DPL=0 S=1 Type=0010(R/W)
...
;A segment created that maps to full address space, for convenience.
...
db 0x0		;Base 31->24
 ...
 ;Segment Descriptor for Segment data (high address)
dw 0x2000	;Limit 15->0
dw 0x10000	;Base 15->0
db 0		;Base 23->16
db 10010010b;P=1 DPL=0 S=1 Type=0010(R/W)
db 01000000b;G=0 W=1 Unused=0 AVL=0
db 0x0		;Base 31->24
